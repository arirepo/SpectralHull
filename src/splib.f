...
************************************************************************
*  REPLACE THIS WITH OPEN SOURCE ALTERNATIVE TO NAG
*  LIBRARY FUNCTION <C06EAF> WHEN WANT TO DO ROUTINES
*  THAT USE FOURIER TRANSFORM. 
************************************************************************
      INTEGER N, IFAIL
...
************************************************************************
*  REPLACE THIS WITH OPEN SOURCE ALTERNATIVE TO NAG
*  LIBRARY FUNCTION <C06EBF> WHEN WANT TO DO ROUTINES
*  THAT USE FOURIER TRANSFORM. 
************************************************************************
      INTEGER N, IFAIL
      DOUBLE PRECISION X(N)
